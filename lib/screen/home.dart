...
import 'package:test_efea/api/repository.dart';
import 'package:test_efea/screen/add_edit_post_screen.dart';
import 'package:test_efea/widgets/post_view.dart';
import 'package:test_efea/model/post.dart';
...
class _HomeState extends State<Home> {
  ...
  Future<void> _loadPosts() async {
    ...
    try {
      ...
      setState(() {
        _currentPage++;
        _posts.clear(); // Clear old posts for a fresh load
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: _loadPosts, // Trigger refresh on pull down
